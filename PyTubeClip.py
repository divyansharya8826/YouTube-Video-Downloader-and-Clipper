...
img = Image("photo", file=os.path.join(basedir,"Images","Babasse-Old-School-Bobines-video.256.png"))
root.tk.call('wm','iconphoto', root._w, img)
root.title("YouTube Video Cliper")
bg = PhotoImage(
    file=os.path.join(basedir,"Images","i.ppm"))
bg2 = PhotoImage(
    file=os.path.join(basedir,"Images","youtubevanced.png"))
